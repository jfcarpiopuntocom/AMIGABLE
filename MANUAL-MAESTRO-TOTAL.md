# MANUAL MAESTRO INTEGRAL Y DOCUMENTACIÓN COMPLETA — amigable-123
*Proyecto:* amigable-123 (PWA local-first de gestión visual y perchas)
*Eslogan:* "Deja de adivinar. Empieza a ver."
*Demo público:* https://jfcarpiopuntocom.github.io/AMIGABLE/
*Manual maestro web:* https://jfcarpiopuntocom.github.io/AMIGABLE/manual-maestro.html
...
* 🔴 **Rojo:** actúa ya.
* ⚫ **Necro:** stock muerto — hora de moverlo.
