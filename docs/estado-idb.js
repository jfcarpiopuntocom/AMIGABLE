// estado-idb.js — AMIGABLE · Espejo del estado del negocio en IndexedDB
// ============================================================================
// BUG QUE ARREGLA (JFC 2026-08-17, en su propia PC):
...
(function () {
  ...
  var DB_NAME = "amigable_estado";      // aislamiento.js le pone el namespace solo
  var STORE = "estado";
  var CLAVE = "actual";
