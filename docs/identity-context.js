/*!
 * identity-context.js — Amigable-123 (nuevo, 2026-07-23)
 *
...
(function (global) {
  ...
  function leerOwned() {
    try {
      var raw = global.localStorage && global.localStorage.getItem("amigable_owned");
  ...
  function construir() {
    ...
    return {
      ...
      // porque en Amigable-123 una licencia = un negocio.
