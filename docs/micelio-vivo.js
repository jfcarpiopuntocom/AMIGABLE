...
(function () {
  ...
  var K_YO = "amigable_micelio_yo";       /* mi apodo y mi id */
  var K_EQUIPO = "amigable_micelio_vistos"; /* último latido de cada quien */
  var K_PERILLA = "amigable_micelio_umbrales";
  var K_AVISADO = "amigable_micelio_avisado";
