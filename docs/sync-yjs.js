// sync-yjs.js — PLAN C del sync (CRDT / Yjs). PORTADO A AMIGABLE (JFC 2026-09-10)
// desde friendly-123. Mismo motor; cambia ROOM_KEY (amigable_sync_room), el relay
// (amigable-sync-relay) y los prefijos de IndexedDB (amig-yjs, porque las 3 apps
// comparten origen en Pages). Detras del flag OC_YJS_FASE0, en paralelo al sync viejo.
//
