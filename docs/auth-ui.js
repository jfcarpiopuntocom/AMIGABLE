...
function _ocMascaraLicencia(inp){
  ...
  function formatear(raw){
    ...
    v = v.slice(0, 15);                       // AMG + 4 + 4 + 4 = 15 caracteres
    var out = v.slice(0, 3);
