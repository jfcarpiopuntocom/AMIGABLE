  ...
  function resp(){
    try{
      ...
      if(angosto){
        ...
        nav.style.cssText="flex:0 0 auto;width:100%;position:sticky;top:0;max-height:none;overflow:visible;flex-direction:row;flex-wrap:wrap;border-right:none;border-bottom:2px solid var(--azul-suave,#dde5ec);padding:6px 0;margin:0 0 12px 0;background:var(--blanco-calido,#F8F9FB);";
        nav.querySelectorAll("[data-riel-go]").forEach(function(b){b.style.width="auto";b.style.borderLeft="none";b.style.padding="8px 10px"});
      }else{
